...
class SeacrhController extends Controller
{
    public function SeacrhBrand(Request $request)
    {
        ...
        return view('frontend.search_brand',compact('thistypeinfo','cnewstop','pagelists','cnewslists','flashlingshibrands','hotnewslists','abrandlists','topbrands','latestbrands','anlinewslists'));
    }
}
