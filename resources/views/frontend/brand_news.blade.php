                ...
                <div class="fl w870 brand_left">
                    ...
                    <div class="clearfix">
                        <div class="brand_content">
                            <div class="stair-wz">
                                {{$thisarticleinfos->brandname}}品牌新闻
                            </div>
                            <div class="det-jies">
                                <ul class="zs-tw-list tab-item ">
                                    @foreach($brandnews as $brandnew)
                                    <li><a target="_blank" href="/news/{{$brandnew->id}}/" class="img-block magnify"><img src="{{$brandnew->litpic}}" alt="{{$brandnew->title}}"></a>
                                        <div class="f20">
                                            <a target="_blank" href="/news/{{$brandnew->id}}/">{{$brandnew->title}}</a>
                                        </div>
                                        <p>{{$brandnew->description}}</p>
                                        <div class="info">
                                            <span><i class="iconfont icon-Time"></i>{{$brandnew->created_at}}</span><span><i class="iconfont icon-link"></i>中国休闲食品加盟网</span>
                                        </div>
                                    </li>
                                    @endforeach
                                </ul>
