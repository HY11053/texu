...
@section('headlibs')
    <link href="{{str_replace('www.','mip.',config('app.url'))}}/mobile/css/article.css" rel="stylesheet" type="text/css"/>
@stop
    ...
    <div class="list_middle">
        ...
        <div class="a_content">
            <div class="body_tit clearfix">
                <div class="clearfix">
                    <div class="chanpin_pic"><mip-img src="{{$thisarticleinfos->litpic}}"></mip-img></div>
                ...
                <div class="shuoming">
                    ...
                    <div class="shuoming_content">
                        <span>{{$thisarticleinfos->pdintr}}</span>
                ...
                <div class="jieshao">
                    ...
                    <div class="content">
                        ...
                        <p>电 话： 400-881-3178</p>
                        <p>传 真： 400-881-3178</p>
                        ...
                        @foreach($productionlists as $productionlist)
                            <div class="item7list">
                                <a href="/item/{{$productionlist->id}}/">
                                    ...
                                    <div class="right fr">
                                        <mip-img src="{{$productionlist->litpic}}"></mip-img>
                                    </div>
                                </a>
                            </div>
                            @endforeach
