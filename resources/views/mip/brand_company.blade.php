@extends('mip.mip')
@section('title'){{$thisarticleinfos->brandname}}品牌介绍-{{$indexname}}@stop
        ...
        <div class="item3box">
            ...
            <div class="top clearfix">
                <div class="topleft fl">
                    <i></i>
                    <p>注：{{$thisarticleinfos->brandname}}投资金额可能包含了加盟费、保证金、品牌使用费等其他相关费用，因此投资总额根据实际情况计算，相关费用解释请参考页面</a>
                    </p>
                </div>
                    ...
                    <div class="jm_xq" id="b-info">
                        <div class="tb-first">
                            <div class="title" id="o-info_1">
                                <h2>{{$thisarticleinfos->brandname}}——公司介绍</h2>
                            </div>
                            <div class="jm_xq_con">
                                {!! $thisarticleinfos->gsjs_content !!}
                            </div>
                        </div>
                        <div class="zhuanzai">
