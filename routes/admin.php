...
Route::post('article/productiondelete/{id}','ArticleController@DeleteProductionArticle');
...
Route::get('article/productcreate','ArticleController@ProductionCreate');
...
Route::get('article/productedit/{id}','ArticleController@ProductEdit');
Route::get('article/productlist','ArticleController@ProdctionList');
...
Route::get('/captcha/{config?}','CaptchasController@Captchas');
    ...
    Route::get('arctypetranslate/getarctypes','ArticleTraslateController@getarctypes');
    Route::get('producttranslate/product','ArticleTraslateController@getProductions');
    Route::get('areatranslate/area','ArticleTraslateController@AreaTranslate');
    ...
    Route::get('/check/checkarticles','CheckToolsController@checkarticles');
    Route::get('/check/updatemipcache','CheckToolsController@updateMipCache');
    Route::get('/check/updabrandcontent','CheckToolsController@updateArticleContent');
    Route::get('/check/updateflags','CheckToolsController@updatteFlags');
    Route::get('/check/brandid','CheckToolsController@checktoolBrandId');
